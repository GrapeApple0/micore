			...
			<div class="col-8 d-flex flex-justify-center flex-items-center pl-md-4">
				...
				?>
					<?php if ($result["status"] == "2") { ?>
						<label class="primary-text"><a class="link" href="<?php echo $rurl ?>"><?php echo $rurl ?></a> ez no ridekka.</label>
					<?php } else { ?>
						<label class="primary-text text-normal"><a class="link" href="<?php echo $rurl ?>"><?php echo $rurl ?></a> la ridekkar ez <a class="link" href="<?php echo $result["result"]; ?>"><?php echo $result["result"]; ?></a></label>
					<?php } ?>
				<?php } ?>
			</div>
		</div>
